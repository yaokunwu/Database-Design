...
drop table SDW$ERR$_DEPARTMENT;
drop table SDW$ERR$_DEPENDENT;
drop table SDW$ERR$_PROJECT;
drop table SDW$ERR$_WORKS_ON;
drop table SDW$ERR$_DEPT_LOCATIONS;
drop table SDW$ERR$_EMPLOYEE;
